...
class Ui_quest_maker_main(object):
    def setupUi(self, quest_maker_main):
        ...
        self.quest_nodes_total_lbl = QtWidgets.QLabel(self.central_widget)
        self.quest_nodes_total_lbl.setObjectName("quest_nodes_total_lbl")
        self.controls.addWidget(self.quest_nodes_total_lbl)
    ...
    def retranslateUi(self, quest_maker_main):
        ...
        self.quest_nodes_total_lbl.setText(_translate("quest_maker_main", "Quest Nodes: "))
        self.reload_database_bttn.setText(_translate("quest_maker_main", "Reload Database"))
