...
class Ui_content_maker_main(object):
    def setupUi(self, content_maker_main):
        content_maker_main.setObjectName("content_maker_main")
        content_maker_main.resize(1200, 800)
        self.central_widget = QtWidgets.QWidget(content_maker_main)
        ...
        self.add_node_bttn = QtWidgets.QPushButton(self.central_widget)
        self.add_node_bttn.setObjectName("add_node_bttn")
        self.controls.addWidget(self.add_node_bttn)
        ...
        self.nodes_total_lbl = QtWidgets.QLabel(self.central_widget)
        self.nodes_total_lbl.setObjectName("nodes_total_lbl")
        self.controls.addWidget(self.nodes_total_lbl)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.controls.addItem(spacerItem)
        self.reload_database_bttn = QtWidgets.QPushButton(self.central_widget)
        self.reload_database_bttn.setAutoRepeatDelay(1000)
        self.reload_database_bttn.setAutoRepeatInterval(1000)
        self.reload_database_bttn.setObjectName("reload_database_bttn")
        self.controls.addWidget(self.reload_database_bttn)
        ...
        content_maker_main.setCentralWidget(self.central_widget)
        self.menu_bar = QtWidgets.QMenuBar(content_maker_main)
        ...
        content_maker_main.setMenuBar(self.menu_bar)
        self.status_bar = QtWidgets.QStatusBar(content_maker_main)
        self.status_bar.setObjectName("status_bar")
        content_maker_main.setStatusBar(self.status_bar)
        self.action_new = QtWidgets.QAction(content_maker_main)
        self.action_new.setObjectName("action_new")
        self.action_open = QtWidgets.QAction(content_maker_main)
        self.action_open.setObjectName("action_open")
        self.action_save = QtWidgets.QAction(content_maker_main)
        self.action_save.setObjectName("action_save")
        self.action_save_As = QtWidgets.QAction(content_maker_main)
        self.action_save_As.setObjectName("action_save_As")
        self.action_about = QtWidgets.QAction(content_maker_main)
        self.action_about.setObjectName("action_about")
        self.action_quit = QtWidgets.QAction(content_maker_main)
        self.action_quit.setObjectName("action_quit")
        self.action_undo = QtWidgets.QAction(content_maker_main)
        self.action_undo.setObjectName("action_undo")
        self.action_redo = QtWidgets.QAction(content_maker_main)
        ...
        self.retranslateUi(content_maker_main)
        self.filter_db.setCurrentIndex(-1)
        QtCore.QMetaObject.connectSlotsByName(content_maker_main)

    def retranslateUi(self, content_maker_main):
        ...
        self.menuEdit.setTitle(_translate("content_maker_main", "Edit"))
        self.action_new.setText(_translate("content_maker_main", "New"))
        self.action_new.setShortcut(_translate("content_maker_main", "Ctrl+N"))
        self.action_open.setText(_translate("content_maker_main", "Open"))
        self.action_open.setShortcut(_translate("content_maker_main", "Ctrl+O"))
        self.action_save.setText(_translate("content_maker_main", "Save"))
        self.action_save.setShortcut(_translate("content_maker_main", "Ctrl+S"))
        self.action_save_As.setText(_translate("content_maker_main", "Save As"))
        self.action_save_As.setShortcut(_translate("content_maker_main", "Ctrl+Shift+S"))
        self.action_about.setText(_translate("content_maker_main", "About"))
        self.action_quit.setText(_translate("content_maker_main", "Quit"))
        self.action_quit.setShortcut(_translate("content_maker_main", "Ctrl+Q"))
        self.action_undo.setText(_translate("content_maker_main", "Undo Save"))
        self.action_undo.setShortcut(_translate("content_maker_main", "Ctrl+Z"))
        self.action_redo.setText(_translate("content_maker_main", "Redo Save"))
        self.action_redo.setShortcut(_translate("content_maker_main", "Ctrl+Shift+Z"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    content_maker_main = QtWidgets.QMainWindow()
    ui = Ui_content_maker_main()
    ui.setupUi(content_maker_main)
    content_maker_main.show()
    sys.exit(app.exec_())
