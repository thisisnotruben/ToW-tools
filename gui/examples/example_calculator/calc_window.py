...
from examples.example_calculator.calc_database import DataView
...
class CalculatorWindow(NodeEditorWindow):
    ...
    def updateWindowMenu(self):
        ...
        toolbar_nodes = self.windowMenu.addAction("DataBase Toolbar")
        toolbar_nodes.setCheckable(True)
        toolbar_nodes.triggered.connect(self.onWindowsDbToolbar)
        toolbar_nodes.setChecked(self.dataDock.isVisible())
    ...
    def onWindowsDbToolbar(self):
        if self.dataDock.isVisible():
            self.dataDock.hide()
        else:
            self.dataDock.show()
